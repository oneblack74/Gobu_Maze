...
public class activationStunBot : MonoBehaviour
{
            ...
            case E_Cellule.Sol:
                ...
                if (VariableGlobale.coordFantome != coord && VariableGlobale.coordTrappe != coord && VariableGlobale.coordCle != coord && !VariableGlobale.dicoPiege.ContainsKey(coord)) {
                    ...
                    if (Input.GetMouseButtonDown(0)) {
                        ...
                        GameObject instantiation = Instantiate(mine, new Vector3(cellHoverLig + 0.5f, cellHoverCol + 0.5f), Quaternion.identity);
                        VariableGlobale.dicoPiege.Add(coord, instantiation);
                        Utilisation();
                    }
                }
                break;
