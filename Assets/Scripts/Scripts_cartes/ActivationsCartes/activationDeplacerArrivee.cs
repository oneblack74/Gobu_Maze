...
public class activationDeplacerArrivee : MonoBehaviour
{
            ...
            case E_Cellule.Sol:
                ...
                if (VariableGlobale.coordFantome != coord && VariableGlobale.coordTrappe != coord && VariableGlobale.coordCle != coord && !VariableGlobale.dicoPiege.ContainsKey(coord)) {
                    ...
                    if (Input.GetMouseButtonDown(0)) {
                        ...
                        VariableGlobale.coordTrappe = coord;
                        Transform trappe = GameObject.Find("Trappe").GetComponent<Transform>();
                        trappe.position = new Vector3(coord.x + 0.5f, coord.y + 0.5f, trappe.position.z);
                        Utilisation();
                    }
                }
                break;
