...
public class activationDeplacerBot : MonoBehaviour
{
            ...
            case E_Cellule.Sol:
                ...
                if (VariableGlobale.coordFantome != coord && VariableGlobale.coordTrappe != coord && VariableGlobale.coordCle != coord && !VariableGlobale.dicoPiege.ContainsKey(coord)) {
                    ...
                    if (Input.GetMouseButtonDown(0)) {
                        ...
                        VariableGlobale.coordFantome = coord;
                        Transform fantome = GameObject.Find("Gobou").GetComponent<Transform>();
                        fantome.position = new Vector3(coord.x + 0.5f, coord.y + 0.5f, fantome.position.z);
                        Utilisation();
                    }
                }
                break;
